...
tf.app.flags.DEFINE_string('network', "dense", "The network to be used as backbone")
#######################
# Training Parameters #
#######################
...
tf.app.flags.DEFINE_integer('step_size', 24000, "Step size for reducing the learning rate, currently only support one step")
...
#tf.app.flags.DEFINE_string('pretrained_model', "./data/imagenet_weights/resnet_v1_101.ckpt", "Pretrained network weights")
tf.app.flags.DEFINE_string('pretrained_model', "./data/imagenet_weights/tf-densenet121.ckpt", "Pretrained network weights")
...
FLAGS2["tbdir"] = osp.abspath(osp.join(FLAGS2["root_dir"], 'data', 'log'))
